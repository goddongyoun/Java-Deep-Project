...
set CLASSPATH=%APP_HOME%\lib\GameProjects-1.0.0.jar


@rem Execute lwjgl3
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LWJGL3_OPTS%  -classpath "%CLASSPATH%" com.mygdx.game.lwjgl3.Lwjgl3Launcher %*
